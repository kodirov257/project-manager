...
dev-build:
	docker build --file=manager/docker/development/nginx/Dockerfile --tag manager-nginx manager/docker/development
	docker build --file=manager/docker/development/php-cli/Dockerfile --tag manager-php-cli manager/docker/development
	docker build --file=manager/docker/development/php-fpm/Dockerfile --tag manager-php-fpm manager/docker/development
...
prod-build:
	docker build --file=manager/docker/production/nginx/Dockerfile --tag manager-nginx manager
	docker build --file=manager/docker/production/php-fpm/Dockerfile --tag manager-php-fpm manager
