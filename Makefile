...
dev-build:
	...
	docker build --file=manager/docker/development/apache/Dockerfile --tag manager-apache manager/docker/development
...
prod-build:
	...
	docker build --file=manager/docker/production/apache/Dockerfile --tag manager-apache manager
